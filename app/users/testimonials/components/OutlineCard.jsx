...
export const OutlineCard = ({testimonial}) => {
    ...
    return (
        ...
        border border-primary rounded-lg p-4 flex-1">
            <p ref={quillRef}></p>

            <div className="flex justify-between mt-5">
                <div className="">
                    <h3 className="text-lg font-bold text-tertiary">{testimonial.personName}</h3>
                    <h4 className="text-tertiary">{testimonial.type}</h4>
                </div>
