            ...
            <div className="flex gap-3 " style={{marginBottom: '20px'}}>
                ...
                <div className="flex justify-end w-full">
                    <div className="flex items-center space-x-2 mr-8 ">                     
                        <button
                        className="flex rounded py-2 items-center text-gray-500 hover:text-blue-500 gap-1"
                    ...
                    <div className="flex items-center space-x-2 mr-8">
                        <button 
                        className="flex text-gray-500 py-2 items-center rounded hover:text-red-500 gap-1"
